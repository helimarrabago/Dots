...
public class Imgproc {
    ...
    //
    // C++:  void circle_corner(Mat& img, Point center, int radius, Scalar color, int thickness = 1, int lineType = LINE_8, int shift = 0)
    //

    //javadoc: circle_corner(img, center, radius, color, thickness, lineType, shift)
